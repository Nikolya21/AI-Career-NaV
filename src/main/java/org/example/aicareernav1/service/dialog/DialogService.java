...
public class DialogService implements DialogRepository {
  ...
  public ChatResponse processMessage(ChatRequest request) {
    ...
    String llmReply = "Ответ от модели (тут должен быть вызов API)";
  ...
  public SummaryResponse summarize(Long userId, DialogType dialogType) {
    ...
    // Формируем финальный запрос к LLM
    String finalRequest = systemPrompt + "\n\nИстория диалога:\n" + historyBuilder.toString();

    // Имитация вызова LLM
    String llmResult = "Здесь будет результат от LLM";
