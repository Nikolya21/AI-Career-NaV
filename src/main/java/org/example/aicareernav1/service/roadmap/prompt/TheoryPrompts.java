...
public class TheoryPrompts {
    ...
    public static final String GENERATE_THEORY_PROMPT = """
            ...
            1. БЛОК МЕТАДАННЫХ (в самом начале):
               - Строка начинается с "METADATA: ".
               - Далее следуют 3-5 ключевых технических тегов через запятую.
               - **ВАЖНО: Первым тегом всегда указывай основной домен технологии (из {mainDomain}).**
               - ПРИМЕР: METADATA: Java, Spring Data JPA, Hibernate, Query Optimization
